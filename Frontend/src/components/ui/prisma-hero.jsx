          ...
          <div className="grid grid-cols-12 items-end gap-4">
            ...
            <div className="col-span-12 lg:col-span-8">
              <h1
                ...
                style={{ color: "#E1E0CC" }}
              >
                <WordsPullUp text="Alvora" showAsterisk />
              </h1>
            </div>
            ...
            <div className="col-span-12 flex flex-col gap-5 pb-6 lg:col-span-4 lg:pb-10">
              ...
              >
                Alvora is a developer analytics platform — track GitHub, LeetCode, Codeforces, and GeeksForGeeks in one unified dashboard.
              </motion.p>
