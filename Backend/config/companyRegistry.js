...
const COMPANIES = [
  ...
  { name: 'Snowflake',    provider: 'ashby',           identifier: 'snowflake',     careerUrl: 'https://careers.snowflake.com',       category: 'data',       priority: 'high',   active: true  },
  ...
  { name: 'HashiCorp',    provider: 'greenhouse',      identifier: 'hashicorp',     careerUrl: 'https://www.hashicorp.com/jobs',      category: 'infra',      priority: 'medium', active: false },
  { name: 'Confluent',    provider: 'ashby',           identifier: 'confluent',     careerUrl: 'https://www.confluent.io/careers',    category: 'data',       priority: 'medium', active: true  },
  ...
  { name: 'Retool',       provider: 'greenhouse',      identifier: 'retool',        careerUrl: 'https://retool.com/careers',          category: 'dev-tools',  priority: 'medium', active: false },
  ...
  { name: 'Perplexity',   provider: 'ashby',           identifier: 'perplexity',    careerUrl: 'https://www.perplexity.ai/careers',   category: 'ai',         priority: 'high',   active: true  },
  ...
  { name: 'Runway',       provider: 'ashby',           identifier: 'runway',        careerUrl: 'https://runwayml.com/careers',        category: 'ai',         priority: 'medium', active: true  },
  { name: 'Weights & Biases', provider: 'greenhouse', identifier: 'wandb',         careerUrl: 'https://wandb.ai/site/careers',       category: 'ai',         priority: 'medium', active: false },
  { name: 'Replicate',    provider: 'greenhouse',      identifier: 'replicate',     careerUrl: 'https://replicate.com/careers',       category: 'ai',         priority: 'medium', active: false },

  // ─── NVIDIA / Chip/Hardware ───────────────────────────────────────────────
  { name: 'NVIDIA',       provider: 'greenhouse',      identifier: 'nvidia',        careerUrl: 'https://www.nvidia.com/en-us/about-nvidia/careers', category: 'hardware', priority: 'high', active: false },
  ...
  { name: 'Plaid',        provider: 'greenhouse',      identifier: 'plaid',         careerUrl: 'https://plaid.com/careers',           category: 'fintech',    priority: 'high',   active: false },
  ...
  { name: 'Ramp',         provider: 'ashby',           identifier: 'ramp',          careerUrl: 'https://ramp.com/careers',            category: 'fintech',    priority: 'high',   active: true  },
  ...
  { name: 'Klarna',       provider: 'greenhouse',      identifier: 'klarna',        careerUrl: 'https://www.klarna.com/careers',      category: 'fintech',    priority: 'medium', active: false },
  { name: 'PayPal',       provider: 'greenhouse',      identifier: 'paypal',        careerUrl: 'https://careers.paypal.com',          category: 'fintech',    priority: 'medium', active: false },
  ...
  // ─── HR / People Tech ─────────────────────────────────────────────────────
  { name: 'Rippling',     provider: 'greenhouse',      identifier: 'rippling',      careerUrl: 'https://www.rippling.com/careers',    category: 'hr-tech',    priority: 'high',   active: false },
  { name: 'Deel',         provider: 'ashby',           identifier: 'deel',          careerUrl: 'https://www.deel.com/careers',        category: 'hr-tech',    priority: 'high',   active: true  },
  ...
  // ─── Ride / Mobility ──────────────────────────────────────────────────────
  { name: 'Uber',         provider: 'greenhouse',      identifier: 'uberfreight',   careerUrl: 'https://www.uber.com/us/en/careers',  category: 'mobility',   priority: 'high',   active: true  },
  ...
  { name: 'Salesforce',   provider: 'greenhouse',      identifier: 'salesforce',    careerUrl: 'https://careers.salesforce.com',      category: 'enterprise', priority: 'medium', active: false },
  ...
  { name: 'Zendesk',      provider: 'greenhouse',      identifier: 'zendesk',       careerUrl: 'https://www.zendesk.com/jobs',        category: 'saas',       priority: 'low',    active: false },
  ...
  { name: 'Segment',      provider: 'greenhouse',      identifier: 'segment',       careerUrl: 'https://segment.com/jobs',            category: 'data',       priority: 'low',    active: false },
  ...
  // ─── Security ────────────────────────────────────────────────────────────
  { name: 'CrowdStrike',  provider: 'greenhouse',      identifier: 'crowdstrike',   careerUrl: 'https://www.crowdstrike.com/careers', category: 'security',   priority: 'medium', active: false },
  ...
  { name: 'Snyk',         provider: 'ashby',           identifier: 'snyk',          careerUrl: 'https://snyk.io/careers',             category: 'security',   priority: 'medium', active: true  },
  { name: 'Lacework',     provider: 'greenhouse',      identifier: 'lacework',      careerUrl: 'https://www.lacework.com/careers',    category: 'security',   priority: 'low',    active: false },
  ...
  // ─── Media / Streaming ────────────────────────────────────────────────────
  { name: 'Spotify',      provider: 'lever',           identifier: 'spotify',       careerUrl: 'https://www.lifeatspotify.com',       category: 'media',      priority: 'high',   active: true  },
  ...
  { name: 'Unity',        provider: 'greenhouse',      identifier: 'unity',         careerUrl: 'https://careers.unity.com',           category: 'gaming',     priority: 'low',    active: false },
  ...
  { name: 'Devoted Health', provider: 'greenhouse',   identifier: 'devoted',       careerUrl: 'https://www.devoted.com/careers',     category: 'healthtech', priority: 'low',    active: false },
  { name: 'Headspace',    provider: 'greenhouse',      identifier: 'headspace',     careerUrl: 'https://www.headspace.com/careers',   category: 'healthtech', priority: 'low',    active: false },
  ...
  { name: 'Opendoor',     provider: 'greenhouse',      identifier: 'opendoor',      careerUrl: 'https://www.opendoor.com/w/careers',  category: 'proptech',   priority: 'low',    active: false },
  ...
  // ─── Consulting / Services ────────────────────────────────────────────────
  { name: 'Palantir',     provider: 'lever',           identifier: 'palantir',      careerUrl: 'https://www.palantir.com/careers',    category: 'enterprise', priority: 'high',   active: true  },

  // ─── Remote-First / Distributed ──────────────────────────────────────────
  { name: 'Automattic',   provider: 'greenhouse',      identifier: 'automattic',    careerUrl: 'https://automattic.com/work-with-us', category: 'remote-first', priority: 'medium', active: false },
  { name: 'Basecamp',     provider: 'lever',           identifier: 'basecamp',      careerUrl: 'https://basecamp.com/jobs',           category: 'remote-first', priority: 'low',  active: false },
  { name: 'Buffer',       provider: 'ashby',           identifier: 'buffer',        careerUrl: 'https://buffer.com/journey',          category: 'remote-first', priority: 'low',  active: true  },
  { name: 'Doist',        provider: 'lever',           identifier: 'doist',         careerUrl: 'https://doist.com/careers',           category: 'remote-first', priority: 'low',  active: false },
  ...
  { name: 'Supabase',     provider: 'ashby',           identifier: 'supabase',      careerUrl: 'https://supabase.com/careers',        category: 'dev-tools',  priority: 'high',   active: true  },
  ...
  { name: 'Neon',         provider: 'greenhouse',      identifier: 'neondatabase',  careerUrl: 'https://neon.tech/careers',           category: 'dev-tools',  priority: 'medium', active: false },

  // ─── Indian Tech Unicorns ─────────────────────────────────────────────────
  { name: 'Razorpay',     provider: 'lever',           identifier: 'razorpay',      careerUrl: 'https://razorpay.com/jobs',           category: 'india-unicorn', priority: 'high',   active: false },
  ...
  { name: 'Swiggy',       provider: 'lever',           identifier: 'swiggy',        careerUrl: 'https://careers.swiggy.com',          category: 'india-unicorn', priority: 'high',   active: false },
  { name: 'Zomato',       provider: 'lever',           identifier: 'zomato',        careerUrl: 'https://www.zomato.com/careers',      category: 'india-unicorn', priority: 'high',   active: false },
  { name: 'Flipkart',     provider: 'lever',           identifier: 'flipkart',      careerUrl: 'https://www.flipkartcareers.com',     category: 'india-unicorn', priority: 'high',   active: false },
  { name: 'Meesho',       provider: 'lever',           identifier: 'meesho',        careerUrl: 'https://meesho.io/jobs',              category: 'india-unicorn', priority: 'high',   active: true  },
  { name: 'Zepto',        provider: 'greenhouse',      identifier: 'zepto',         careerUrl: 'https://www.zeptonow.com/careers',    category: 'india-unicorn', priority: 'high',   active: false },
  { name: 'PhonePe',      provider: 'lever',           identifier: 'phonepe',       careerUrl: 'https://careers.phonepe.com',         category: 'india-unicorn', priority: 'high',   active: false },
  { name: 'Paytm',        provider: 'greenhouse',      identifier: 'paytm',         careerUrl: 'https://paytm.com/care/career',       category: 'india-unicorn', priority: 'medium', active: false },
  { name: 'Ola',          provider: 'lever',           identifier: 'ola',           careerUrl: 'https://ola.careers',                 category: 'india-unicorn', priority: 'medium', active: false },
  { name: 'Dream11',      provider: 'greenhouse',      identifier: 'dream11',       careerUrl: 'https://dream11.com/careers',         category: 'india-unicorn', priority: 'medium', active: false },
  { name: 'BrowserStack', provider: 'greenhouse',      identifier: 'browserstack',  careerUrl: 'https://www.browserstack.com/careers', category: 'india-unicorn', priority: 'medium', active: false },
  ...
  { name: 'CleverTap',    provider: 'greenhouse',      identifier: 'clevertap',     careerUrl: 'https://clevertap.com/careers',       category: 'india-unicorn', priority: 'low',  active: false },
  ...
  { name: 'Airtable',     provider: 'greenhouse',      identifier: 'airtable',      careerUrl: 'https://airtable.com/careers',        category: 'productivity', priority: 'medium', active: true },
  { name: 'Scale AI',     provider: 'greenhouse',      identifier: 'scaleai',       careerUrl: 'https://scale.com/careers',           category: 'ai',         priority: 'high',   active: true  },
  { name: 'Anduril',      provider: 'greenhouse',      identifier: 'andurilindustries', careerUrl: 'https://www.anduril.com/careers', category: 'deeptech',   priority: 'medium', active: true  },
  { name: 'Navan',        provider: 'greenhouse',      identifier: 'navan',         careerUrl: 'https://navan.com/careers',           category: 'hr-tech',    priority: 'medium', active: false },
  ...
  { name: 'Faire',        provider: 'greenhouse',      identifier: 'faire',         careerUrl: 'https://www.faire.com/careers',       category: 'ecommerce',  priority: 'medium', active: false },
  ...
  { name: 'Coda',         provider: 'greenhouse',      identifier: 'coda',          careerUrl: 'https://coda.io/careers',             category: 'productivity', priority: 'low',  active: false },
  { name: 'Weights & Biases', provider: 'greenhouse', identifier: 'wandb',         careerUrl: 'https://wandb.ai/site/careers',       category: 'ai',         priority: 'medium', active: false },
  ...
  { name: 'Roboflow',     provider: 'ashby',           identifier: 'roboflow',      careerUrl: 'https://roboflow.com/careers',        category: 'ai',         priority: 'low',    active: true  },

  // ─── Adobe / Creative ────────────────────────────────────────────────────
  { name: 'Adobe',        provider: 'greenhouse',      identifier: 'adobe',         careerUrl: 'https://www.adobe.com/careers.html',  category: 'enterprise', priority: 'medium', active: false },

  // ─── Oracle / SAP / Enterprise ───────────────────────────────────────────
  { name: 'Oracle',       provider: 'greenhouse',      identifier: 'oracle',        careerUrl: 'https://www.oracle.com/corporate/careers', category: 'enterprise', priority: 'low', active: false },

  // ─── Open Source / OSS-driven ────────────────────────────────────────────
  { name: 'Red Hat',      provider: 'greenhouse',      identifier: 'redhat',        careerUrl: 'https://www.redhat.com/en/jobs',      category: 'enterprise', priority: 'low',    active: false },
  ...
  // ─── VC-backed Breakouts ─────────────────────────────────────────────────
  { name: 'Glean',        provider: 'greenhouse',      identifier: 'glean',         careerUrl: 'https://glean.com/careers',           category: 'ai',         priority: 'high',   active: false },
  { name: 'Hex',          provider: 'greenhouse',      identifier: 'hex',           careerUrl: 'https://hex.tech/careers',            category: 'data',       priority: 'medium', active: false },
  { name: 'dbt Labs',     provider: 'greenhouse',      identifier: 'dbtlabs',       careerUrl: 'https://www.getdbt.com/careers',      category: 'data',       priority: 'medium', active: false },
  { name: 'Airbyte',      provider: 'greenhouse',      identifier: 'airbyte',       careerUrl: 'https://airbyte.com/careers',         category: 'data',       priority: 'medium', active: false },
  ...
  { name: 'Stytch',       provider: 'ashby',           identifier: 'stytch',        careerUrl: 'https://stytch.com/careers',          category: 'security',   priority: 'medium', active: true  },
  { name: 'Clerk',        provider: 'ashby',           identifier: 'clerk',         careerUrl: 'https://clerk.com/careers',           category: 'security',   priority: 'medium', active: true  },
  ...
  { name: 'Redpanda',     provider: 'greenhouse',      identifier: 'redpanda',      careerUrl: 'https://redpanda.com/careers',        category: 'infra',      priority: 'low',    active: false },
  ...
  { name: 'Teleport',     provider: 'ashby',           identifier: 'goteleport',    careerUrl: 'https://goteleport.com/careers',      category: 'security',   priority: 'low',    active: true  },

  // ─── Crypto / Web3 ───────────────────────────────────────────────────────
  { name: 'Alchemy',      provider: 'greenhouse',      identifier: 'alchemy',       careerUrl: 'https://www.alchemy.com/careers',     category: 'web3',       priority: 'medium', active: false },
  ...
  { name: 'Chainalysis',  provider: 'greenhouse',      identifier: 'chainalysis',   careerUrl: 'https://www.chainalysis.com/careers', category: 'web3',       priority: 'low',    active: false },
  ...
  { name: 'Arcadia',      provider: 'lever',           identifier: 'arcadia',       careerUrl: 'https://www.arcadia.com/careers',     category: 'climate',    priority: 'low',    active: true  },
  ...
  { name: 'AngelList',    provider: 'lever',           identifier: 'angellist',     careerUrl: 'https://angel.co/company/angellist/jobs', category: 'recruiting', priority: 'low', active: true },
  ...
  { name: 'FullStory',    provider: 'greenhouse',      identifier: 'fullstory',     careerUrl: 'https://www.fullstory.com/careers',   category: 'saas',       priority: 'low',    active: false },
  { name: 'Heap',         provider: 'greenhouse',      identifier: 'heap',          careerUrl: 'https://heap.io/careers',             category: 'data',       priority: 'low',    active: false },
  { name: 'LaunchDarkly', provider: 'greenhouse',      identifier: 'launchdarkly',  careerUrl: 'https://launchdarkly.com/careers',    category: 'dev-tools',  priority: 'medium', active: false },
  { name: 'Split',        provider: 'greenhouse',      identifier: 'split',         careerUrl: 'https://www.split.io/careers',        category: 'dev-tools',  priority: 'low',    active: false },
  { name: 'Statsig',      provider: 'ashby',           identifier: 'statsig',       careerUrl: 'https://www.statsig.com/careers',     category: 'dev-tools',  priority: 'medium', active: true  },

  // ─── Workday ATS ─────────────────────────────────────────────────────────────
  // identifier format: "{tenant}|{wdInstance}|{boardId}"
  { name: 'Adobe',        provider: 'workday',         identifier: 'adobe|wd5|external_experienced',              careerUrl: 'https://adobe.wd5.myworkdayjobs.com',     category: 'enterprise', priority: 'high',   active: true  },
  { name: 'NVIDIA',       provider: 'workday',         identifier: 'nvidia|wd5|NVIDIAExternalCareerSite',         careerUrl: 'https://nvidia.wd5.myworkdayjobs.com',    category: 'hardware',   priority: 'high',   active: true  },
  { name: 'Salesforce',   provider: 'workday',         identifier: 'salesforce|wd12|External_Career_Site',        careerUrl: 'https://salesforce.wd12.myworkdayjobs.com', category: 'enterprise', priority: 'high', active: true  },
  { name: 'CrowdStrike',  provider: 'workday',         identifier: 'crowdstrike|wd5|crowdstrikecareers',          careerUrl: 'https://crowdstrike.wd5.myworkdayjobs.com', category: 'security',  priority: 'high',   active: true  },
  { name: 'Zoom',         provider: 'workday',         identifier: 'zoom|wd5|Zoom',                               careerUrl: 'https://zoom.wd5.myworkdayjobs.com',      category: 'communication', priority: 'medium', active: true },
];
...
const getRegistryStats = () => ({
  ...
  byProvider: {
    ...
    workday:    COMPANY_REGISTRY.filter((c) => c.active && c.provider === 'workday').length,
  },
